    ...
    <div className="py-12 pb-24">
      <div className="max-w-2xl mx-auto px-6">
        ...
        <div className="flex flex-col gap-3 mt-8">
          <Link
            to="/"
            className="h-14 bg-gray-900 hover:bg-gray-700 text-white text-sm font-bold tracking-widest uppercase rounded flex items-center justify-center transition-colors"
          >
            Continue shopping
          </Link>
          ...
          <Link
            to="/orders"
            className="h-14 border border-gray-200 hover:border-gray-400 text-gray-900 text-sm font-semibold rounded flex items-center justify-center transition-colors"
          >
            View all orders
          </Link>
        </div>
